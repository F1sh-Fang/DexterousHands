...
from dexhand.algorithms.marl.utils.separated_buffer import SeparatedReplayBuffer
from dexhand.utils.util import update_linear_schedule
...
class Runner:
    ...
    def __init__(self,
        ...
        if self.algorithm_name == "happo":
            from dexhand.algorithms.marl.happo_trainer import HAPPO as TrainAlgo
            from dexhand.algorithms.marl.happo_policy import HAPPO_Policy as Policy
        if self.algorithm_name == "hatrpo":
            from dexhand.algorithms.marl.hatrpo_trainer import HATRPO as TrainAlgo
            from dexhand.algorithms.marl.hatrpo_policy import HATRPO_Policy as Policy
        if self.algorithm_name == "mappo":
            from dexhand.algorithms.marl.mappo_trainer import MAPPO as TrainAlgo
            from dexhand.algorithms.marl.mappo_policy import MAPPO_Policy as Policy

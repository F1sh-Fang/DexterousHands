...
from dexhand.algorithms.offrl.iql import IQL_Model
from dexhand.algorithms.offrl.iql import ReplayBuffer
...
class IQL:
    ...
    def run(self, num_learning_iterations, log_interval=1):
        ...
        policy = IQL_Model(state_dim, action_dim, max_action, self.device, self.discount, self.tau, self.expectile, self.beta)

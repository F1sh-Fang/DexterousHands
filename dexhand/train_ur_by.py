...
from dexhand.utils.process_marl import get_AgentIndex
from dexhand.algorithms.rl.ppo import PPO
from dexhand.tasks.hand_base.vec_task import VecTaskPython, VecTaskPythonArm
...
if __name__ == '__main__':
    set_np_formatting()
    args = get_args(task_name="UrBotyardHandPick", algo="ppo")

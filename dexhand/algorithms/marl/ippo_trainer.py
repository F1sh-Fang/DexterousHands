...
from dexhand.utils.util import get_gard_norm, huber_loss, mse_loss
from dexhand.algorithms.marl.utils.valuenorm import ValueNorm
from dexhand.algorithms.utils.util import check
...
class IPPO():
    ...
    def __init__(self,
        ...
        self._use_value_active_masks = config["use_value_active_masks"]  # false in IPPO
        self._use_policy_active_masks = config["use_policy_active_masks"]  # false in IPPO
